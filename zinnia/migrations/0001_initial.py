    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='zinnia.Category', verbose_name='parent category')),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_template', models.CharField(choices=[(b'zinnia/_entry_detail.html', 'Default template')], default=b'zinnia/_entry_detail.html', help_text="Template used to display the entry's content.", max_length=250, verbose_name='content template')),
                ('detail_template', models.CharField(choices=[(b'entry_detail.html', 'Default template')], default=b'entry_detail.html', help_text="Template used to display the entry's detail page.", max_length=250, verbose_name='detail template')),
            ],
            options={
