...
PAGINATION = getattr(settings, 'ZINNIA_PAGINATION', 6)
...
PREVIEW_MAX_WORDS = getattr(settings, 'ZINNIA_PREVIEW_MAX_WORDS', 30)
...
COMMENT_MIN_WORDS = getattr(settings, 'ZINNIA_COMMENT_MIN_WORDS', 10)
...
UPLOAD_TO_GALLERY = getattr(settings, 'ZINNIA_UPLOAD_TO_GALLERY', 'uploads/gallery')

PROTOCOL = getattr(settings, 'ZINNIA_PROTOCOL', 'http')

FEEDS_FORMAT = getattr(settings, 'ZINNIA_FEEDS_FORMAT', 'rss')
FEEDS_MAX_ITEMS = getattr(settings, 'ZINNIA_FEEDS_MAX_ITEMS', 10)
